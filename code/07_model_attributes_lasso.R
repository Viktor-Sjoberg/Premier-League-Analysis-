...
model_glmnet <- read_rds("fit/model_glmnet_laso.rds")
...
png("img/Regularization_paths_lasso.png")
plot(model_glmnet, xvar = "lambda", label = TRUE)
dev.off()
...
precision_recall_curves_plot_lasso <- ggplot(pr_data_clean, aes(x = Recall, y = Precision, color = Class)) +
  geom_line() +
...
ggsave("img/precision_recall_curves_plot_lasso.png", plot = precision_recall_curves_plot_lasso, width = 12, height = 6, bg = "white")
