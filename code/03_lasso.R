...
saveRDS(model_glmnet, "fit/model_glmnet_lasso.rds")
...
saveRDS(best_lambda, "values/best_lambda_lasso.rds")
saveRDS(best_threshold1, "values/best_threshold1_lasso.rds")
saveRDS(best_threshold2, "values/best_threshold2_lasso.rds")
...
class_gt
gt_output2 <- "img/lasso_class_gt.png"
...
ggsave("img/conf_matrix_plot_lasso.png", plot = conf_matrix_plot, width = 12, height = 6, bg = "white")
